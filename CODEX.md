...
- Read canonical router: `decapod docs show` [core/DECAPOD.md](constitution/core/DECAPOD.md).
...
- Operator reference: `decapod docs show` [docs/PLAYBOOK.md](constitution/docs/PLAYBOOK.md).
