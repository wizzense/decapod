...
- Update tool names in README.md
...
## [0.60.10](https://github.com/DecapodLabs/decapod/compare/v0.60.9...v0.60.10) - 2026-06-26

### Other

- Fix QA verify replay for completed todos

## [0.60.9](https://github.com/DecapodLabs/decapod/compare/v0.60.8...v0.60.9) - 2026-06-24

### Fixed

- *(entrypoint)* sync template assets with Interface abstraction boundary anchor

## [0.60.8](https://github.com/DecapodLabs/decapod/compare/v0.60.7...v0.60.8) - 2026-06-24

### Other

- fix mdBook deployment and remove redundant Jekyll page
...
- Fix Deploy Docs: proper mdBook install, CSS path, premium styling (applies to PR #704)
- Update README documentation section & style mdBook
...
## [0.58.1](https://github.com/DecapodLabs/decapod/compare/v0.58.0...v0.58.1) - 2026-05-30

### Added

- *(init)* implement cloud backend choice and auth0 authentication flow
...
- fix CI lint, fmt, and clippy failures ([#664](https://github.com/DecapodLabs/decapod/pull/664))
...
- *(constitution)* library of 80 seminal research papers and core router ([#658](https://github.com/DecapodLabs/decapod/pull/658))
...
- Restrict 'decapod docs' to 'docs/agent/' paths ([#648](https://github.com/DecapodLabs/decapod/pull/648))
...
- Convert bash test scripts to Rust ([#627](https://github.com/DecapodLabs/decapod/pull/627))

## [0.56.0](https://github.com/DecapodLabs/decapod/compare/v0.55.2...v0.56.0) - 2026-05-28

### Added

- scaffold GitHub Action for project validation in decapod init ([#622](https://github.com/DecapodLabs/decapod/pull/622)) ([#625](https://github.com/DecapodLabs/decapod/pull/625))
...
- constitution v2 upgrade, container best-practices, and multi-agent coordination ([#615](https://github.com/DecapodLabs/decapod/pull/615))
...
- workspace ergonomics and detection (#601, #602, #603, #604, #605) ([#606](https://github.com/DecapodLabs/decapod/pull/606))

## [0.53.1](https://github.com/DecapodLabs/decapod/compare/v0.53.0...v0.53.1) - 2026-05-26

### Added

- implement non-interactive initialization with --proof flag ([#599](https://github.com/DecapodLabs/decapod/pull/599))

## [0.53.0](https://github.com/DecapodLabs/decapod/compare/v0.52.2...v0.53.0) - 2026-05-26

### Added

- implement comprehensive dual-audience documentation system ([#596](https://github.com/DecapodLabs/decapod/pull/596))
...
- fix workspace todo coordination ([#572](https://github.com/DecapodLabs/decapod/pull/572))
...
- Typed JSON-RPC Handlers and Constitution Alignment ([#567](https://github.com/DecapodLabs/decapod/pull/567))
...
## [0.48.7](https://github.com/DecapodLabs/decapod/compare/v0.48.6...v0.48.7) - 2026-05-20
...
- *(init)* render selector as interactive tui
