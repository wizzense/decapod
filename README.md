...
<p align="center">
  Decapod is a daemonless, local-first governance kernel for agentic coding fleets. Users stay inside Cursor, Claude Code, Codex, Gemini CLI, and other agent tools while agents 
